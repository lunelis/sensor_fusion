...
run(Size)->
    ...
    cmp_fct_1i(Size, eye, fun oldmat:eye/1, fun numerl:eye/1),
    cmp_fct_1(Size, inversion, fun oldmat:inv/1, fun numerl:inv/1),
    cmp_fct_1(Size, transpose, fun oldmat:tr/1, fun numerl:transpose/1),
    cmp_fct_2(Size, mult, fun oldmat:'*'/2, fun numerl:mult/2),
    cmp_fct_2im(Size, mult, fun oldmat:'*'/2, fun numerl:mult/2).